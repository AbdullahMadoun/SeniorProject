...
class GeometryTests(unittest.TestCase):
    ...
    def test_area_validation_rejects_large_pattern(self) -> None:
        waypoints = [
            Waypoint(lat=24.689000, lon=50.174000, alt_m=25.0),
            Waypoint(lat=24.689700, lon=50.174000, alt_m=25.0),
            Waypoint(lat=24.689700, lon=50.174700, alt_m=25.0),
            Waypoint(lat=24.689000, lon=50.174700, alt_m=25.0),
        ]
