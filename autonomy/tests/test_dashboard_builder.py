...
class DashboardBuilderTests(unittest.TestCase):
    ...
    def test_render_dashboard_html_contains_leaflet_three_and_live_api_hooks(self) -> None:
        ...
        self.assertIn("fpv-detection-layer", html)
        self.assertIn("FPV_DETECTION_STALE_MS = 500", html)
        self.assertIn("clearFpvDetection", html)
        self.assertIn("updateFpvDetection(frame)", html)
